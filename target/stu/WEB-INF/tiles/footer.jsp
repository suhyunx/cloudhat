...
<%--		<img src="/data/yedda/foot_logo.png">--%>
		<address>
				<span style="" class="footCopyrightbtn" onclick="onopen();" valign="absmiddle">사업자정보확인</span> 서울 금천구 중구 동호로 256<br>
				 대표자명: 박지명<span class="bar">｜</span>사업자등록번호: 111-81-01111<span class="bar">｜</span>문의전화: 070-111-1111<span class="bar">｜</span>팩스: 02-1111-1111<span class="bar"><br>
				</span> 통신판매신고: 제2022-서울금천-0111호 <span class="bar">｜</span> 개인정보관리책임자: 전형준 (a@a.co.kr)<br>
				<br>
